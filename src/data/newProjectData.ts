...
export const ProjectsData: ProjectData[] = [
  ...
  },
  {
    ...
    teamMembers: [
      { name: "Areel Khan" },
      { name: "Carter Demars" },
      { name: "Anupra Chandran" },
      { name: "Bill Bai" },
      { name: "Mihir Gupta" },
      { name: "Raihan Abdul Vaheed" }
    ],
  ...
  },
  {
    ...
    teamMembers: [
      { name: "Anusha Raisinghani" },
      { name: "Trevor Yu" },
      { name: "Adish Shah" },
      { name: "Ethan Gabriel" },
      { name: "Musaab Siddiqui" },
      { name: "Urban Pistek" },
      { name: "Yask Pokra" }
    ],
  },
